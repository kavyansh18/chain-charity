        ...
        <nav className="mt-2 flex justify-center items-center">
          ...
          {!authToken ? (
            ...
            <button
              ...
              className=" ml-6 relative inline-flex items-center justify-center px-4 py-1 overflow-hidden font-medium
    text-indigo-600 transition duration-300 ease-out rounded-full shadow-xl group hover:ring-1 hover:ring-purple-500"
            >
